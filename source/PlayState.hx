			...
			switch (Paths.formatToSongPath(SONG.song))
			{
				case 'lycanthrope':
					if (alreadyshowed) {
						...
						LoadingState.loadAndSwitchState(new VideoState("assets/videos/FNF-Lyc cutscene 3.webm", new PlayState()));
						alreadyshowed = false;
					}
					else {
						camHUD.visible = true;
				...
				case 'rejoice':
					if (alreadyshowed) {
						FlxTransitionableState.skipNextTransIn = false;
						FlxTransitionableState.skipNextTransOut = false;
						LoadingState.loadAndSwitchState(new VideoState("assets/videos/FNF-Lyc cutscene 2.webm", new PlayState()));
						alreadyshowed = false;
					}
					else {
						camHUD.visible = true;
				...
				case 'before-the-storm':
					if (alreadyshowed) {
						FlxTransitionableState.skipNextTransIn = false;
						FlxTransitionableState.skipNextTransOut = false;
						LoadingState.loadAndSwitchState(new VideoState("assets/videos/FNF-Lyc cutscene 1.webm", new PlayState()));
						alreadyshowed = false;
					}
					else {
						camHUD.visible = true;
				...
				if (storyPlaylist.length <= 0)
				{
					...
					switch (Paths.formatToSongPath(SONG.song))
					{
						case 'lycanthrope':
								FlxTransitionableState.skipNextTransIn = false;
								FlxTransitionableState.skipNextTransOut = false;
								LoadingState.loadAndSwitchState(new VideoState("assets/videos/FNF-Lyc cutscene 4.webm", new StoryMenuState()));
						default:
